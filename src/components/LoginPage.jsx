        ...
        <div className="min-h-screen flex w-full bg-slate-50">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative overflow-hidden flex-col justify-between p-12 text-white">
                ...
                <div className="relative z-10 text-xs text-slate-600">
                    © 2026 Joyson Safety Systems. All rights reserved.
                </div>
            </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-lg leading-5 bg-slate-50 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ease-in-out hover:bg-white focus:bg-white"
